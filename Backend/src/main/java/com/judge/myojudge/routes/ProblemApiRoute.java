...
public final class ProblemApiRoute {
    ...
    public static final String PROBLEM_FETCH_BY_ID_V1 = "/api/problem/v1/{id}";
    public static final String PROBLEM_FETCH_ALL = "/api/problem/v1/all";
    public static final String PROBLEM_FETCH_BY_CATEGORY = "/api/problem/v1/{category}";
    public static final String PROBLEM_FETCH_BY_ID_V2= "/api/problem/v2/{id}";
